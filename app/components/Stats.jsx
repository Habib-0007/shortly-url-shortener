...
export default function Stats() {
	return (
		<section className="px-4 md:px-16 py-8 flex justify-between items-center flex-col gap-6">
			<div className="flex justify-between items-center flex-col gap-3 text-center">
			...
			<div className="flex justify-between items-center gap-16 md:gap-6 flex-col md:flex-row mt-[16px] relative h-full">
